...
public class MainScreenActivity extends AppCompatActivity {
    ...
    TextView tvDiscover, tvMap, tvMyNetwork, tvRequest, tvMyPosts, tvCustomText, tvCustomImage1, tvCustomImage2;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        tvDiscover.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                tvDiscover.setBackgroundResource(R.color.colorPrimary);

                tvMyPosts.setBackgroundResource(R.color.colorPrimaryDark);
        ...
        tvMap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(final View v) {
                tvMap.setBackgroundResource(R.color.colorPrimary);
        ...
        tvMyPosts.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(final View v) {
                tvMyPosts.setBackgroundResource(R.color.colorPrimary);
                tvMyNetwork.setBackgroundResource(R.color.colorPrimaryDark);
                tvMap.setBackgroundResource(R.color.colorPrimaryDark);
                tvRequest.setBackgroundResource(R.color.colorPrimaryDark);
                tvDiscover.setBackgroundResource(R.color.colorPrimaryDark);
        ...
        tvRequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                tvRequest.setBackgroundResource(R.color.colorPrimary);
        ...
        tvMyNetwork.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(final View v) {
                tvMyNetwork.setBackgroundResource(R.color.colorPrimary);
